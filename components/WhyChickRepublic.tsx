                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {trustItems.map((item, index) => (
                        <motion.div
                            ...
                            className="p-8 rounded-[2rem] border-2 border-gray-50 hover:border-brand-red/10 transition-colors group text-center lg:text-left"
                        >
                            ...
                            <h4 className="text-xl font-black text-brand-blue mb-4 uppercase tracking-tight group-hover:text-brand-red transition-colors">
                                {item.title}
                            </h4>
