                        ...
                        {steps.map((step, index) => (
                            ...
                            >
                                <div className="relative mb-8">
                                    <div className="w-24 h-24 bg-white border-4 border-gray-100 text-brand-blue rounded-full flex items-center justify-center group-hover:border-brand-red transition-all duration-300 shadow-premium">
                                        <step.icon size={40} />
                                    </div>
                                    <div className="absolute -top-2 -right-2 w-10 h-10 bg-brand-red text-white font-black rounded-full flex items-center justify-center text-lg shadow-lg">
                                        {index + 1}
                                    </div>
                                </div>
                                <h4 className="text-2xl font-black text-brand-blue mb-4 uppercase tracking-tight">
                                    {step.title}
                                </h4>
