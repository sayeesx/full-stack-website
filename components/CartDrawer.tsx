                    ...
                    >
                        ...
                        {cart.length > 0 && (
                            <div className="p-8 border-t border-gray-100 bg-white space-y-6">
                                ...
                                <Button variant="primary" size="lg" fullWidth className="py-5 text-xl group">
                                    Proceed to Checkout
                                    <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={24} />
                                </Button>

                                <p className="text-[10px] text-center font-bold text-gray-400 uppercase tracking-[0.2em]">
