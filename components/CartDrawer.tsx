                    ...
                    >
                        ...
                        {cart.length > 0 && (
                            <div className="p-8 border-t border-gray-100 bg-white space-y-6">
                                ...
                                <Button variant="primary" size="lg" fullWidth className="py-5 text-lg group bg-brand-blue hover:bg-brand-red shadow-xl shadow-brand-blue/20 hover:shadow-brand-red/30 transition-all rounded-2xl">
                                    Proceed to Checkout
