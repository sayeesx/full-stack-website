...
export const Button: React.FC<ButtonProps> = ({
    ...
    const sizes = {
        sm: 'px-3 py-1.5 md:px-4 md:py-2 text-[10px] md:text-xs uppercase tracking-wider',
        md: 'px-4 py-2 md:px-6 md:py-2.5 text-xs md:text-sm uppercase tracking-wider',
        lg: 'px-6 py-2.5 md:px-10 md:py-3.5 text-sm md:text-base uppercase tracking-widest',
    };
